...
const TemplatePreviewBody = ({
  ...
  const isStandaloneOverlay = Boolean(onDismiss);

  return (
    <ScreenContainer
      scroll
      includeTopInset={isStandaloneOverlay}
      paddingTop={16}
    ...
    >
      <View style={{ gap: 14 }}>
        ...
        <View style={{ marginTop: 6, gap: 10 }}>
          ...
          >
            Adding creates your own copy so you can edit it without affecting
            the original.
          </Text>
        </View>
      </View>
