...
exports.findUserByOriginalTransaction =
  exports.decodeNotification =
  exports.recordNotification =
  exports.validateAndActivate =
  exports.upsertAppleSubscription =
  exports.fetchSubscriptionStatus =
  exports.fetchTransaction =
    void 0;
...
const getClient = () => {
  ...
  return new app_store_server_library_1.AppStoreServerAPIClient(
    sanitizedKey,
    APP_STORE_KEY_ID,
    APP_STORE_ISSUER_ID,
    APP_STORE_BUNDLE_ID,
...
const fetchTransaction = async (transactionId) => {
  ...
  const transaction = decodeSignedPayload(
...
const validateAndActivate = async (userId, transactionId) => {
  ...
  const status = await (0, exports.fetchSubscriptionStatus)(
    transaction.originalTransactionId
  );
  const renewalInfo = status?.renewalInfo ?? undefined;
  const updatedStatus = await (0, exports.upsertAppleSubscription)(
    userId,
    transaction,
    renewalInfo
  );
