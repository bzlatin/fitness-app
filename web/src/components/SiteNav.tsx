...
export default function SiteNav() {
  ...
  return (
    <header className='sticky top-0 z-50 border-b border-border/70 bg-background/75 backdrop-blur supports-[backdrop-filter]:bg-background/55'>
      ...
      <div
        id={menuId}
        className={`fixed inset-0 z-[100] isolate md:hidden ${open ? '' : 'pointer-events-none'}`}
        aria-hidden={!open}
      >
        <div
        ...
        <div
          ...
          className={`absolute right-0 top-0 h-full w-[86%] max-w-sm border-l border-border/70 bg-gradient-to-b from-background via-background to-surface shadow-[0_24px_80px_rgba(0,0,0,0.65)] transition-transform ${
